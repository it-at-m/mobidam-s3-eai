    ...
    public void configure() {
        ...
        from("{{camel.route.common}}")
                ...
                .toD(String.format(
                        ...
                        CommonConstants.HEADER_BUCKET_NAME, CommonConstants.HEADER_ACCESS_KEY, CommonConstants.HEADER_SECRET_KEY, Constants.ARCHIVE_PATH, Constants.PARAMETER_OBJECT_NAME))
